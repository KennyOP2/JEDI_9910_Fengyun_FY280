...
#define PAL_FILE_OPEN_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_CLOSE_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_READ_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_WRITE_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_SEEK_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_TELL_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_EOF_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_DELETE_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_DISK_GET_FREE_SPACE_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_FIND_FIRST_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_FIND_NEXT_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)

#define PAL_FILE_FIND_CLOSE_CALLBACK_DECL(func, param, result, arg) \
    void func(PAL_FILE * param, MMP_ULONG result, void *arg)
