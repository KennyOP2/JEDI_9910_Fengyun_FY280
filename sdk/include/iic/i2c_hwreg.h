...
#define REG_I2C_CONTROL        (I2C_BASE + 0)
#define REG_I2C_STATUS         (I2C_BASE + 4)
#define REG_I2C_CLOCK_DIV      (I2C_BASE + 8)
#define REG_I2C_DATA           (I2C_BASE + 0x0C)
#define REG_I2C_SLAVE_ADDR     (I2C_BASE + 0x10)
#define REG_I2C_GLITCH         (I2C_BASE + 0x14)
#define REG_I2C_BUS_MONITOR    (I2C_BASE + 0x18)
#define REG_I2C_REV_NUMBER     (I2C_BASE + 0x30)
#define REG_I2C_FEATURE        (I2C_BASE + 0x34)
...
#define REG_MASK_GSR                            (0xE00)
#define REG_SHIFT_GSR                           (9)
#define REG_MASK_TSR                            (0x2FF)
