...
typedef struct AVC_ENCODER_TAG
{
    ...
    MMP_UINT8* pSourceBufAdrY[4];        //[OUT]
    MMP_UINT8* pSourceBufAdrU[4];        //[OUT]
    MMP_UINT8* pSourceBufAdrV[4];        //[OUT]
    MMP_UINT8* pTiledSrcBufAdrY[4];      //[OUT]
    MMP_UINT8* pTiledSrcBufAdrU[4];      //[OUT]
    MMP_UINT8* pTiledSrcBufAdrV[4];      //[OUT]
