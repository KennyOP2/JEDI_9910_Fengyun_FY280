 ...
 ************************************************************************
 */
MMP_UINT16 get_mem3Dfloat(MMP_FLOAT ****array3D, int frames, int rows, int columns);
 ...
 ************************************************************************
 */
MMP_UINT32 get_mem2Dfloat(MMP_FLOAT ***array2D, int rows, int columns);
 ...
 ************************************************************************
 */
void free_mem3Dfloat(MMP_FLOAT ***array3D, int frames);
 ...
 ************************************************************************
 */
void free_mem2Dfloat(MMP_FLOAT **array2D);       
