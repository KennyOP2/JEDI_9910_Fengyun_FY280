...
extern HDMITX_DETIMING timingDE;
...
BOOL ProgramSyncEmbeddedByVIC(BYTE VIC, BYTE bInputType);
BOOL ProgramSyncEmbeddedByTiming(VIDEO_Timing *pVTiming, BYTE bInputSignalType);
    #endif
...
BYTE CheckHDMITX(BYTE *pHPD, BYTE *pHPDChange);
    #else
BYTE CheckHDMITX(BYTE *pHPD, BYTE *pHPDChange, BYTE *audStatus);
    #endif
...
void DumpCatHDMITXReg();
    #ifdef HDMITX_IT66121
BOOL getHDMITX_AuthenticationDone();//2015.3.23 my.wei add
    #endif
