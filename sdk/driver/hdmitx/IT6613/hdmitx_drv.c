...
BOOL EnableAudioOutput(ULONG VideoPixelClock, BYTE bAudioSampleFreq, BYTE ChannelNumber, BYTE bAudSWL, BYTE bSPDIF)
{
    ...
    if (bSPDIF)
        bAudioChannelEnable |= B_AUD_SPDIF;
...
BYTE
CheckHDMITX(BYTE *pHPD, BYTE *pHPDChange, BYTE *audStatus)
{
    ...
    *audStatus = SetupAudioChannel(); // 2007/12/12 added by jj_tseng
