...
//=============================================================================
/**
 * PIXELPLUS_PH1100K Set Input Data Pin.
 */
//=============================================================================
static void 
    ...
    void)
{
    ...
    MMP_UINT8 Y_16Pin[CAP_DATA_BUS_WIDTH] = {27, 28, 29, 30, 31, 32, 33, 34, 0, 0, 0, 0};
    MMP_UINT8 U_16Pin[CAP_DATA_BUS_WIDTH] = {17, 18, 19, 20, 21, 22, 23, 24, 0, 0, 0, 0};
    ...
    void)
{
    ...
    Capctxt->inmux_info.UCLKVDSel = 35; 
