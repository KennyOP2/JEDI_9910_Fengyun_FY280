...
#define wll_write(event,pba,ppo,buffer,sparebuffer) prg_wrapper((long)ll_write,(long)(pba),(long)(ppo),(long)(buffer),(long)(sparebuffer),event)
...
#define wll_write(event,pba,ppo,buffer,sparebuffer) ll_write(pba,ppo,buffer,sparebuffer)
