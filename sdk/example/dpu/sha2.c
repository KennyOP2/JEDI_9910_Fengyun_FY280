           ...
           unsigned char output[32], int is224 )
{
	...
	memcpy( output, (unsigned char*)ctx.state, 32);
...
/*
 * Checkup routine Drigo's code
 */
int sha2_self_test2( int verbose )
{
    ...
    src_len = unhexify( src_str, "11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111");
...
void SwSha2Caculate( unsigned char *Src, unsigned char *Dst, unsigned int Size)
{
#ifdef	SHA2_FIXED_PATTERN
    unsigned char src_str[64];
    unsigned char output[32];
    int src_len,i;
