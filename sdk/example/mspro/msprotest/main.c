...
#define TEST_SIZE   2*1024*1024
    ...
    {
        result = mmpMsproReadMultipleSector(512, 1, buffer);
        if(result)
            goto end;
    }
    ...
    {
        result = mmpMsproReadMultipleSector(512, 2, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
    ...
    {
        result = mmpMsproReadMultipleSector(512, 4, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
    ...
    {
        result = mmpMsproReadMultipleSector(512, 8, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
    ...
    {
        result = mmpMsproReadMultipleSector(512, 16, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
    ...
    {
        result = mmpMsproReadMultipleSector(512, 32, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
    ...
    {
        result = mmpMsproReadMultipleSector(512, 64, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
    ...
    {
        result = mmpMsproReadMultipleSector(512, 128, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
    ...
    {
        result = mmpMsproReadMultipleSector(512, 256, buffer);
        if(result)
            goto end;
    }
    duration = PalGetDuration(startTime);
...
void TestLowLevel(void)
{
    ...
    MMP_UINT8* r2 = buf2+1;
#endif
#if 0 // fail, R => W => R => W => R:fail, command not complete, dma complete
    MMP_UINT8* r1 = buf1;
    MMP_UINT8* r2 = buf2+2;
#endif
#if 0 // ok
    ...
    MMP_UINT8* r2 = buf2+2;
#endif
#if 0 // fail, R => W => R:fail, command not complete, dma complete 
    MMP_UINT8* r1 = buf1+2;
    MMP_UINT8* r2 = buf2;
#endif
#if 1 // fail, R => W => R:fail, command not complete, dma complete   
    MMP_UINT8* r1 = buf1+2;
    MMP_UINT8* r2 = buf2+1;
#endif
#if 0 // fail, R => W => R:fail, command not complete, dma complete
    ...
    result = mmpMsproReadMultipleSector(512, 1, r1);
    if(result)
        goto end;

    result = mmpMsproWriteMultipleSector(512, 1, r1);
    if(result)
        goto end;

    result = mmpMsproReadMultipleSector(512, 1, r2);
    if(result)
        goto end;
...
//===========
    result = mmpMsproWriteMultipleSector(512, 1, r2);
    if(result)
        goto end;
