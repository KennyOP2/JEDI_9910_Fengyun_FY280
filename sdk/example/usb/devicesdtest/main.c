    ...
    MMP_UINT8 lun)
{
    ...
    case SMEDIA_SD:
        #if defined(ENABLE_SD)
        ready = mmpSdGetCardState(SD_INSERTED);
        #endif
        break;
    case RAM_DISCK:
        ready = MMP_TRUE;
    ...
    MMP_UINT16* srcBuffer)
{
    ...
    case SMEDIA_SD:
        #if defined(ENABLE_SD)
        result = mmpSdReadMultipleSector(blockId, sizeInSector,(void*)srcBuffer);
        #endif
        break;
    case RAM_DISCK:
    ...
    MMP_UINT16* dstBuffer)
{
    ...
    case SMEDIA_SD:
        #if defined(ENABLE_SD)
        result = mmpSdWriteMultipleSector(blockId, sizeInSector,(unsigned char*)dstBuffer);
        #endif
        break;
    case RAM_DISCK:
...
Initialize(void)
{
    PAL_THREAD thread = MMP_NULL;
    PAL_THREAD thread1 = MMP_NULL;
    ...
    thread = PalCreateThread(PAL_THREAD_USBEX, 
                            USBEX_ThreadFunc, 
                            MMP_NULL, 
                            2000, 
    ...
    thread1 = PalCreateThread(PAL_THREAD_USB_DEVICE, 
                            DEVICE_ThreadFunc, 
                            MMP_NULL, 
                            2000, 
                            PAL_THREAD_PRIORITY_NORMAL);
