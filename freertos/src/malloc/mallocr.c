...
/*
  HAVE_TRACE add by Kuoping for malloc trace call back functions.
*/
#define HAVE_TRACE
...
#  ifdef HAVE_TRACE
STATIC int (*__mALLoCEnter)(size_t, size_t) = 0;
STATIC int (*__fREeEnter)(size_t) = 0;
#  endif // HAVE_TRACE
...
#  ifdef HAVE_TRACE
extern int (*__mALLoCEnter)(size_t, size_t);
extern int (*__fREeEnter)(size_t);
#  endif // HAVE_TRACE
...
#endif
{
  ...
  ptr = malloc (bytes); // Make sure that the pointer returned by malloc is returned back.
  goto end;
...
#ifdef HAVE_TRACE
  if(__mALLoCEnter) (*__mALLoCEnter)(bytes, (size_t)ptr);
#endif
...
#ifdef HAVE_TRACE
  if(__fREeEnter) (*__fREeEnter)((int)mem);
#endif
...
#ifdef HAVE_TRACE
    case M_MALLOC_CALLBACK:
      __mALLoCEnter = (void*)value; MALLOC_UNLOCK; return 1; 
    case M_FREE_CALLBACK:
      __fREeEnter = (void*)value; MALLOC_UNLOCK; return 1; 
#endif
