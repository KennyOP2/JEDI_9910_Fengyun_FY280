...
#define taskSOFTWARE_BREAKPOINT()   portSOFTWARE_BREAKPOINT()
#define xTaskGetTime(s, m, u)       timer_get_time((unsigned*)s, (unsigned*)m, (unsigned*)u)
 ...
 * task. h
 *<pre>
 portBASE_TYPE xTaskRestart(
                              xTaskHandle pxTaskHandle,
                              pdTASK_CODE pvTaskCode,
                              void *pvParameters);</pre>
 *
 * Restart a task.
 *
 * \defgroup xTaskCreate xTaskRestart
 * \ingroup Tasks
 */
...
/**
 * task. h
 * <PRE>volatile portTickType xTaskGetTimerCount( void );</PRE>
 *
 * @return The count of timer in milliseconds since vTaskStartScheduler was called.
 *
 * \page xTaskGetTimerCount xTaskGetTimerCount
 * \ingroup TaskUtils
 */
...
/**
 * task. h
 * <PRE>volatile void xTaskTimerUpdate( void );</PRE>
 *
 * @update the timer setting if the clock period changed.
 *
 * \page xTaskTimerUpdate xTaskTimerUpdate
 * \ingroup TaskUtils
 */
...
/**
 * task. h
 * <PRE>void vTaskInitRunTimeStats( void );</PRE>
 *
 ...
 *
 * \page vTaskInitRunTimeStats vTaskInitRunTimeStats
 * \ingroup TaskUtils
 */
