...
#define MP2_ENCODER_PARAMETER    0x16ee
...
#  define DrvShowSpectrumMode_Bits         9  //avoid use wave encode mmio 
...
#  define DrvShowSpectrum         (1  << DrvShowSpectrumMode_Bits) //D[9]
...
/////////////////////////////////////////////////////////////////
// Audio Processor Write register protection
/////////////////////////////////////////////////////////////////
#define AUDIO_WRITE_STREAM_BUFFER_BIT   0
#define AUDIO_READ_STREAM_BUFFER_BIT     1

#define AUDIO_WRITE_STREAM_BUFFER           (1  << AUDIO_WRITE_STREAM_BUFFER_BIT)           // D[0]
#define AUDIO_READ_STREAM_BUFFER             (1  << AUDIO_READ_STREAM_BUFFER_BIT)           // D[1]
/////////////////////////////////////////////////////////////////
// MP2 Encoder register
/////////////////////////////////////////////////////////////////
#define MP2_ENCODE_CH_BIT      0
#define MP2_ENCODE_SAMPLERATE_BIT 1  //  1 ~~3

#define MP2_ENCODE_CH (1  << MP2_ENCODE_CH_BIT)    // D[0]
#define MP2_ENCODE_SAMPLERATE (7  << MP2_ENCODE_SAMPLERATE_BIT)    // D[3:1]
/////////////////////////////////////////////////////////////////
// Read/Write Pointer
/////////////////////////////////////////////////////////////////
...
#    define getAC3PrintMetaDataMode() ((MMIO_Read(AC3_DECODER_PARAMETER)& AC3_PRINT_METADATA_MODE) >> AC3_PRINT_METADATA_MODE_BITS)

/* Audio stream buffer protection parameter */
#    define occupyAudioWriteBuffer()     MMIO_Write(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION, (MMIO_Read(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION) |  AUDIO_WRITE_STREAM_BUFFER ))
#    define releaseAudioWriteBuffer()    MMIO_Write(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION, (MMIO_Read(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION) & ~AUDIO_WRITE_STREAM_BUFFER ))
#    define occupyAudioReadBuffer()      MMIO_Write(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION, (MMIO_Read(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION) |  AUDIO_READ_STREAM_BUFFER ))
#    define releaseAudioReadBuffer()     MMIO_Write(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION, (MMIO_Read(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION) & ~AUDIO_READ_STREAM_BUFFER ))
#    define getAudioWriteBufferStatus() (MMIO_Read(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION) & AUDIO_WRITE_STREAM_BUFFER)
#    define getAudioReadBufferStatus()  (MMIO_Read(AUDIO_PROCESSOR_WRITE_REGISTER_PROTECTION) & AUDIO_READ_STREAM_BUFFER)

/* MP2 Encoder register */
#    define getMP2EncCh() ((MMIO_Read(MP2_ENCODER_PARAMETER)& MP2_ENCODE_CH) >> MP2_ENCODE_CH_BIT)
#    define getMP2EncSampleRate() ((MMIO_Read(MP2_ENCODER_PARAMETER)& MP2_ENCODE_SAMPLERATE) >> MP2_ENCODE_SAMPLERATE_BIT)
...
#    else // defined(__FREERTOS__)
    ...
    PROFILE_FUNC void MMIO_Write(unsigned short addr, unsigned short data);
    #define MMIO_Write_From_ISR MMIO_Write

    PROFILE_FUNC unsigned int MMIO_Read(unsigned short addr);
    PROFILE_FUNC unsigned int MMIO_Read_From_ISR(unsigned short addr);

    PROFILE_FUNC void MMIO_WriteMask(unsigned short addr, unsigned short data, unsigned short mask);
